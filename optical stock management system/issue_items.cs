...
{
    public partial class issue_items : Form
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (qnt > Convert.ToInt32(txtquntity.Text))
                {
                    qnt = qnt - Convert.ToInt32(txtquntity.Text);
                    MessageBox.Show("items issued", "Stock Status", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
